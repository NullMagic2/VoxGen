...
need('use voxgen::playback_dsp::{' in http and 'OutputPeakGuard, PlaybackControls, StreamingPlaybackDsp, OUTPUT_PEAK_CEILING' in http, 'HTTP imports playback DSP from library crate')
...
print('v0.7.60 shared library import validation passed')
